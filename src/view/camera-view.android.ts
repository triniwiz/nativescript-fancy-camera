...
export class CameraView extends CameraViewBase {
  ...
  public createNativeView() {
    ...
    app.android.on(
      ...
      (args: app.AndroidActivityRequestPermissionsEventData) => {
        if (
        ...
        onPhotoEventUI(event: any) {
          ...
          if (
            ...
            event
              .getMessage()
              .indexOf(
                co.fitcom.fancycamera.PhotoEvent.EventInfo.PHOTO_TAKEN.toString()
              ) > -1
          ) {
            owner.notify({
              eventName: 'finished',
  ...
  public onLoaded(): void {
    super.onLoaded();
    this.nativeView.setListener(this.listener);
    this.startPreview();
  }
  ...
  public onUnloaded(): void {
    ...
    this.nativeView.setListener(null);
    super.onUnloaded();
  }
